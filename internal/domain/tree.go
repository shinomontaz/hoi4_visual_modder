...
// SubTree represents a sub-tree within a technology folder
type SubTree struct {
	Name         string        // Display name (e.g., "Electronic Engineering")
	XMin         int           // Minimum X coordinate
	XMax         int           // Maximum X coordinate
	Categories   []string      // Technology categories in this sub-tree
	Technologies []*Technology // Technologies in this sub-tree
}
...
type TechnologyTree struct {
	...
	SubTrees     map[string][]*SubTree  // Folder -> Sub-trees
}
